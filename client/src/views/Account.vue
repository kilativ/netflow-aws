                      ...
                      <table class="w-full p-5 text-gray-700">
                          <thead>
                              <tr>
                                  ...
                                  <th class="text-left text-blue-900">Number</th>
                                  <th class="text-left text-blue-900">Type</th>
                                  <th class="text-left text-blue-900">Balance</th>
                                  <th class="text-left text-blue-900">Snapshot</th>
                              </tr>
                          </thead>
                          ...
                          <tbody>
                              <tr v-for="account in bank.accounts" :key="account.account_id">
                                  ...
                                  <td>{{ formatter.currencyUSD(account.balances.current) }}</td>
                                  <td><a class="underline" v-bind:href="'/snapshot/' + account.account_id">view</a></td>
                              </tr>
                          </tbody>
                      </table>
              </div>
